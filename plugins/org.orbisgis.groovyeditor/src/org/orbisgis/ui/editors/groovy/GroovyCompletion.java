...
/**
 * Methods to use Groovy Language Server to realize auto-completion with groovy.
 *
 * @author Adrien Bessy, CNRS
 */
public class GroovyCompletion {
	
	private static final String PATH_WORKSPACE = "./build/test_workspace/";
	private static final String PATH_SRC = "./src/main/groovy";
	
	private Path workspaceRoot = Paths.get(System.getProperty("user.dir")).resolve(PATH_WORKSPACE);
	private Path srcRoot = workspaceRoot.resolve(PATH_SRC);
